...
canvas_right_btn = Canvas(width=100, height=100, highlightthickness=0, bg=BACKGROUND_COLOR)
right_btn = PhotoImage(file="./images./right.png")
canvas_wrong_btn = Canvas(width=100, height=100, highlightthickness=0, bg=BACKGROUND_COLOR)
